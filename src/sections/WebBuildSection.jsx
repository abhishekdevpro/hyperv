        ...
        <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:gap-12">
          ...
          <div className="lg:w-1/2 mt-10 lg:mt-0">
            ...
            <div className="space-y-4 text-gray-700 text-lg">
              <p>
                Build better, faster, and more user-friendly digital solutions
                with our tools and products.
              </p>
              <p>
                We help web developers, startups, creators, and entrepreneurs by
                providing a reliable starting point that cuts their initial
                design and coding budget in half, bringing their projects closer
                to launch.
              </p>
            </div>
          </div>
