...
//           <p className="text-md font-normal text-gray-500 text-center">AI-powered freelancing & contract marketplace</p>
//         </div>
//         {/* Kushi Gateway */}
//         <div className="flex flex-col items-center p-4 sm:p-6 bg-white/50 backdrop-blur-sm rounded-xl hover:shadow-lg transition-all duration-300">
...
//           <p className="text-md font-normal text-gray-500 text-center">A nonprofit initiative for empowerment and second chances</p>
//         </div>
//         {/* LegitZone.Law */}
//         <div className="flex flex-col items-center p-4 sm:p-6 bg-white/50 backdrop-blur-sm rounded-xl hover:shadow-lg transition-all duration-300">
...
//           <p className="text-md font-normal text-gray-500 text-center">Simplifying legal services with AI-driven automation</p>
//         </div>
//       </div>
...
import React from "react";
import { Grid3X3, Wallet, Scale, ExternalLink } from "lucide-react";
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-white relative">
      ...
      <div className="mt-8 sm:mt-12 md:mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12 max-w-4xl mx-auto relative">
        {/* Freevance */}
        <a 
          href="https://freevance.com/" 
          className="flex flex-col items-center p-4 sm:p-6 bg-white/50 backdrop-blur-sm rounded-xl hover:shadow-lg transition-all duration-300 group relative"
          target="_blank"
        ...
        >
          ...
          <Grid3X3 size={48} className="mb-3 sm:mb-4 text-gray-600" />
          <div className="text-xl sm:text-2xl font-semibold text-gray-900">Freevance</div>
          <p className="text-md font-normal text-gray-500 text-center">AI-powered freelancing & contract marketplace</p>
        </a>
        ...
        >
          ...
          <Wallet size={48} className="mb-3 sm:mb-4 text-yellow-500" />
          <div className="text-xl sm:text-2xl font-semibold text-gray-900">Kushi Gateway</div>
          <p className="text-md font-normal text-gray-500 text-center">A nonprofit initiative for empowerment and second chances</p>
        </a>
        ...
        >
          ...
          <Scale size={48} className="mb-3 sm:mb-4 text-red-800" />
          <div className="text-xl sm:text-2xl font-semibold text-gray-900">LegitZone.Law</div>
          <p className="text-md font-normal text-gray-500 text-center">Simplifying legal services with AI-driven automation</p>
        </a>
      </div>
